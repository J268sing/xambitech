...
export class EditEntry {
  constructor(attribute, attributeName, type, isRequired, validations, extraParam) {
    this.attribute = attribute;           // Should be a string
    this.attributeName = attributeName;   // Should be a string
    this.type = type;                     // Should be of a specific type related to EditEntryType
    this.isRequired = isRequired;         // Should be a boolean
    this.validations = validations;       // Should be an array of ValidationType
    this.extraParam = extraParam;         // Type can be any unknown value
  }
}


export class EditFormProps {
  constructor(title, description, editEntries, entityObj, onSubmitSuccess) {
    this.title = title;                        // Should be a string
    this.description = description;            // Should be a string
    this.editEntries = editEntries;            // Should be an array of EditEntry instances
    this.entityObj = entityObj;                // Type can be any unknown value
    this.onSubmitSuccess = onSubmitSuccess;    // Should be a function
  }
}
